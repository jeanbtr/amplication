...
import { WhistlistFindManyArgs } from "../../whistlist/base/WhistlistFindManyArgs";
import { Whistlist } from "../../whistlist/base/Whistlist";
...
export class UserControllerBase {
  ...
  async findWhistlists(
    @common.Req() request: Request,
    @common.Param() params: UserWhereUniqueInput
  ): Promise<Whistlist[]> {
    const query = plainToClass(WhistlistFindManyArgs, request.query);
    const results = await this.service.findWhistlists(params.id, {
      ...query,
      select: {
        createdAt: true,
        id: true,
  ...
  @common.Post("/:id/whistlists")
  @nestAccessControl.UseRoles({
    resource: "User",
    action: "update",
    possession: "any",
  })
  async connectWhistlists(
    @common.Param() params: UserWhereUniqueInput,
    @common.Body() body: WhistlistWhereUniqueInput[]
  ): Promise<void> {
    const data = {
      whistlists: {
        connect: body,
  ...
  @common.Patch("/:id/whistlists")
  @nestAccessControl.UseRoles({
    resource: "User",
    action: "update",
    possession: "any",
  })
  async updateWhistlists(
    @common.Param() params: UserWhereUniqueInput,
    @common.Body() body: WhistlistWhereUniqueInput[]
  ): Promise<void> {
    const data = {
  ...
  @common.Delete("/:id/whistlists")
  @nestAccessControl.UseRoles({
    resource: "User",
    action: "update",
    possession: "any",
  })
  async disconnectWhistlists(
    @common.Param() params: UserWhereUniqueInput,
    @common.Body() body: WhistlistWhereUniqueInput[]
  ): Promise<void> {
    const data = {
